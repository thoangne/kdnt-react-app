...
import {
  ...
  TabContext_default,
  useNavItem
} from "./chunk-VNNDYTJI.js";
import "./chunk-ZMC43FMP.js";
...
import {
  Anchor_default
} from "./chunk-TDYXSMFW.js";
import {
  require_browser,
  useUncontrolled,
  useUncontrolledProp
} from "./chunk-5FPPGXWJ.js";
...
import {
  ...
  renderTransition,
  useWaitForDOMRef
} from "./chunk-VPFGOHOX.js";
import {
  divWithClassName_default
} from "./chunk-7OVK67NT.js";
import {
  contains
} from "./chunk-CZVXOELG.js";
import {
  safeFindDOMNode
} from "./chunk-G42ZNGB6.js";
import {
  listen_default,
  ownerDocument
} from "./chunk-RSEX4CAT.js";
import "./chunk-3NPLRFU4.js";
import {
  useCallbackRef
...
var FormControl = React28.forwardRef(({
  ...
  return (0, import_jsx_runtime29.jsx)(Component2, {
    ...
    readOnly,
    id: id || controlId,
    className: (0, import_classnames24.default)(className, plaintext ? `${bsPrefix}-plaintext` : bsPrefix, size && `${bsPrefix}-${size}`, type === "color" && `${bsPrefix}-color`, isValid && "is-valid", isInvalid && "is-invalid")
  });
});
...
var NavDropdown = React42.forwardRef(({
  ...
  return (0, import_jsx_runtime45.jsxs)(Dropdown_default, {
    ref,
    ...props,
    className: (0, import_classnames36.default)(className, navItemPrefix),
    children: [(0, import_jsx_runtime44.jsx)(Dropdown_default.Toggle, {
      id,
      eventKey: null,
      active,
      disabled,
